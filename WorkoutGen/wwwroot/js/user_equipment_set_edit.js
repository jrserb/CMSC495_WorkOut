/*
    ...
    Desc: Script page for equipmentsets/edit.cshtml
*/
...
$(document).ready(function () {
    ...
    $('#btnDeleteEquipmentSet').on('click', function (e) {

        const equipmentSetId = $('#UserEquipmentSetId').attr('id');

        $('#formEditEquipmentSet')
            .attr('action', `/EquipmentSets/Edit/${equipmentSetId}?handler=DeleteEquipmentSet`)
            .submit();
    });
