/*
    ...
    Desc: This is a data layer service for user exercise db transactions
*/
            ...
            for (int i = 0; i < muscleGroupExerciseIds.Count(); i++)
            {
                ...
                foreach (var objEquipment in requiredEquipment)
                {
                    ...
                    if (!equipmentIds.Contains(objEquipment.Id))
                    {
                        ...
                        //exerciseEquipmentIds = await _equipmentDb.GetUserExerciseEquipmentIdsFromExerciseAndEquipment(muscleGroupExerciseIds[i], objEquipment.Id);
